            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="https://img.icons8.com/pastel-glyph/2x/system-task.png" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>System</h5> <span class="mail-desc">All messages will appear here!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="https://cornwallminingalliance.org/wp-content/uploads/2016/10/Placeholder-male.jpg" alt="user"></div>
                                            <div class="u-text">
                        ...
                        @else
                        <li class="nav-item"><span class="badge badge-danger"> Please Login</span></li>
                        @endauth
                    </ul>
                </div>
            </nav>
        ...
        <aside class="left-sidebar">
            ...
            @else
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="nav-devider"></li>
                        <li class="nav"><span class="badge badge-danger"> Please Login</span></li>
                    </ul>
                </nav>
            @endauth
        </aside>
